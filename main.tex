...
One last thing to remark here is that the imaginary time $i\epsilon$ is somehow identified with the $i\epsilon$ prescription of the Feynman propagator, which we will not explain here.
